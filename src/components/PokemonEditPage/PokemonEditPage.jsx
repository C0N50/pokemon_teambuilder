...
function PokemonEditPage({ setPokemonEditFlag, pokemonEditFlag }) {
  ...
  const capitalized =
    selectedPokemon?.species?.name.charAt(0).toUpperCase() +
    selectedPokemon?.species?.name.slice(1);
